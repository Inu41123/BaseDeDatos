...
CREATE TABLE Lector (
    ...
    ap2 NVARCHAR(20),
    CONSTRAINT CHK_Lector_numlector_Positivo 
    CHECK (numlector > 0),
    CONSTRAINT CHK_Lector_nummateria_Positivo 
    CHECK (nummateria > 0),
...
CREATE TABLE Libro (
    ...
    CONSTRAINT CHK_Libro_numlibro_Positivo 
    CHECK (numlibro > 0),
...
CREATE TABLE Presta (
    ...
    CONSTRAINT CHK_Presta_Numlibro_Positivo 
    CHECK (Numlibro > 0),
    CONSTRAINT CHK_Presta_numlector_Positivo 
    CHECK (numlector > 0),
