...
CREATE TABLE ALUMNO (
    ...
    ap2 NVARCHAR(20),
    CONSTRAINT CHK_ALUMNO_numalumno_Positivo 
    CHECK (numalumno > 0),
...
CREATE TABLE CURSO (
    ...
    CONSTRAINT CHK_CURSO_numcurso_Positivo 
    CHECK (numcurso > 0),
    CONSTRAINT PK_CURSO 
...
CREATE TABLE PARTICIPAN (
    ...
    CONSTRAINT PK_PARTICIPAN 
    PRIMARY KEY (numalumnoFK, numcursoFK), 
    CONSTRAINT FK_PARTICIPAN_ALUMNO 
    FOREIGN KEY (numalumnoFK) 
    REFERENCES ALUMNO(numalumno),
    CONSTRAINT FK_PARTICIPAN_CURSO 
...
CREATE TABLE UBICACION (
    ...
    CONSTRAINT CHK_UBICACION_ubicacionid_Positivo 
    CHECK (ubicacionid > 0),
