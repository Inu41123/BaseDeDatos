...
CREATE TABLE Paciente (
    ...
    CONSTRAINT CHK_Paciente_idpaciente_Positivo CHECK (idpaciente > 0),
...
CREATE TABLE Medico (
    ...
    CONSTRAINT CHK_Medico_idmedico_Positivo CHECK (idmedico > 0),
    CONSTRAINT UQ_Medico_numcolegiado UNIQUE (numcolegiado),
...
CREATE TABLE Cita (
    ...
    CONSTRAINT CHK_Cita_idcita_Positivo CHECK (idcita > 0),
    CONSTRAINT CHK_Cita_idpaciente_Positivo CHECK (idpaciente > 0),
    CONSTRAINT CHK_Cita_idmedico_Positivo CHECK (idmedico > 0),
    CONSTRAINT CHK_Cita_estado_Valido CHECK (estado IN ('P', 'C')),
...
CREATE TABLE Diagnostico (
    ...
    tratamiento TEXT,
    CONSTRAINT CHK_Diagnostico_iddiagnostico_Positivo CHECK (iddiagnostico > 0),
    CONSTRAINT CHK_Diagnostico_idcita_Positivo CHECK (idcita > 0),
...
CREATE TABLE Receta (
    ...
    CONSTRAINT CHK_Receta_idreceta_Positivo CHECK (idreceta > 0),
    CONSTRAINT CHK_Receta_iddiagnostico_Positivo CHECK (iddiagnostico > 0),
...
CREATE TABLE Historia_Clinica (
    ...
    alergias TEXT,
    antecedentes TEXT,
    CONSTRAINT CHK_HistoriaClinica_idhistoria_Positivo CHECK (idhistoria > 0),
    CONSTRAINT CHK_HistoriaClinica_idpaciente_Positivo CHECK (idpaciente > 0),
    CONSTRAINT PK_Historia_Clinica PRIMARY KEY (idhistoria),
